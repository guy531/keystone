...
% NMI Q -------------------------------------------------------------------
subplot(2, 3, 3);
Q_MI = plot(hmp.MI_graph, 'XData', hmp.MI_y(:, 1), 'YData', hmp.MI_y(:, 2), ...
    'EdgeColor', 'k', 'EdgeAlpha', edgealpha, 'NodeCData', hmp.Q,...
    'MarkerSize', MI_marker_size);
row1 = dataTipTextRow('Name', hmp.OTU(:, 2));
Q_MI.DataTipTemplate.DataTipRows(end+1) = row1;




% Highlighting positive
highlight(Q_MI, hmp.node_start_pos, hmp.node_end_pos, 'EdgeColor',bcolor);
% Highlighting negative
highlight(Q_MI, hmp.node_start_neg, hmp.node_end_neg, 'EdgeColor',rcolor);
set(gca,'XTick',[]);
set(gca,'YTick',[]);
text(letterposx, letterposy, 'c', 'Units', 'normalized', 'FontSize', 25, 'FontWeight', 'bold');
% xlabel('$Q^i$', 'Interpreter', 'latex', 'FontSize', fontsize);
% title('EPI using Q', 'FontSize', 20);
set(gca, 'FontSize', fontsize*2);
colormap('jet');
colorbar
text(1.4, 0.5, 'Q', 'Units', 'normalized', 'FontSize', 25);
box off; 
axis off;
axis square;
...
% NMI D1 ------------------------------------------------------------------
subplot(2, 3, 1);
D1_MI = plot(hmp.MI_graph, 'XData', hmp.MI_y(:, 1), 'YData', hmp.MI_y(:, 2), ...
    'EdgeColor', 'k', 'EdgeAlpha', edgealpha, 'NodeCData', hmp.D1,...
    'MarkerSize', MI_marker_size);
row1 = dataTipTextRow('Name', hmp.OTU(:, 2));
D1_MI.DataTipTemplate.DataTipRows(end+1) = row1;
% Highlighting positive
highlight(D1_MI, hmp.node_start_pos, hmp.node_end_pos, 'EdgeColor',bcolor);
% Highlighting negative
highlight(D1_MI, hmp.node_start_neg, hmp.node_end_neg, 'EdgeColor',rcolor);
set(gca,'XTick',[]);
set(gca,'YTick',[]);
text(letterposx, letterposy, 'a', 'Units', 'normalized', 'FontSize', 25, 'FontWeight', 'bold');
% title('EPI using D_1');
% xlabel('$Q^i$', 'Interpreter', 'latex', 'FontSize', fontsize);
set(gca, 'FontSize', fontsize*2);
colormap('jet');
colorbar
text(1.4, 0.5, 'D_1', 'Units', 'normalized', 'FontSize', 25);
box off; 
axis off;
axis square;
...
% NMI D2 ------------------------------------------------------------------
subplot(2, 3, 2);
D2_MI = plot(hmp.MI_graph, 'XData', hmp.MI_y(:, 1), 'YData', hmp.MI_y(:, 2), ...
    'EdgeColor', 'k', 'EdgeAlpha', edgealpha, 'NodeCData', hmp.D2,...
    'MarkerSize', MI_marker_size);
row1 = dataTipTextRow('Name', hmp.OTU(:, 2));
D2_MI.DataTipTemplate.DataTipRows(end+1) = row1;
% Highlighting positive
highlight(D2_MI, hmp.node_start_pos, hmp.node_end_pos, 'EdgeColor',bcolor);
% Highlighting negative
highlight(D2_MI, hmp.node_start_neg, hmp.node_end_neg, 'EdgeColor',rcolor);
set(gca,'XTick',[]);
set(gca,'YTick',[]);
text(letterposx, letterposy, 'b', 'Units', 'normalized', 'FontSize', 25, 'FontWeight', 'bold');
% title('EPI using D_2');
set(gca, 'FontSize', fontsize*2);
colormap('jet');
colorbar
text(1.4, 0.5, 'D_2', 'Units', 'normalized', 'FontSize', 25);
box off; 
axis off;
axis square;

% Correlation between nodes in the MI graph
% figure; 
% set(gcf, 'Position', [20 100 1000 500], 'Units', 'centimeters');
% Q -----------------------------------------------------------------
subplot(2, 3, 6); hold on;
temp1 = table2array(hmp.MI_graph.Edges);
temp2 = hmp.Q;
temp3 = temp2(randperm(length(temp2)));
scatter(temp3(temp1(:, 1)), temp3(temp1(:, 2)), sz, [0.6 0.6 0.6], 'filled', 'MarkerEdgeColor', 'none');
scatter(temp2(temp1(:, 1)), temp2(temp1(:, 2)), sz, [0 0 0], 'filled', 'MarkerEdgeColor', 'none');
ylabel('Q for nearest neighbors of i', 'FontSize', 25); xlabel('Q for node i');
set(gca, 'FontSize', fontsize);
text(letterposx, letterposy, 'f', 'Units', 'normalized', 'FontSize', 25, 'FontWeight', 'bold');
% legend('Present', 'Absent', 'FontSize', 13);
set(gca, 'FontSize', fontsize*2);
[r,p] = corr(temp2(temp1(:, 1)), temp2(temp1(:, 2)), 'rows', 'complete');
...
scatter(temp3(temp1(:, 1)), temp3(temp1(:, 2)), sz, [0.6 0.6 0.6], 'filled', 'MarkerEdgeColor', 'none');
scatter(temp2(temp1(:, 1)), temp2(temp1(:, 2)), sz, [0 0 0], 'filled', 'MarkerEdgeColor', 'none');
ylabel('D_1 for nearest neighbors of i', 'FontSize', 25); xlabel('D_1 for node i');
set(gca, 'FontSize', fontsize);
text(letterposx, letterposy, 'd', 'Units', 'normalized', 'FontSize', 25, 'FontWeight', 'bold');
set(gca, 'FontSize', fontsize*2);
% legend('Present', 'Absent', 'FontSize', 13);
[r,p] = corr(temp2(temp1(:, 1)), temp2(temp1(:, 2)), 'rows', 'complete');
text(0.6, 0.15, "r = " + string(r) + newline + "p = " + string(p),...
...
scatter(temp3(temp1(:, 1)), temp3(temp1(:, 2)), sz, [0.6 0.6 0.6], 'filled', 'MarkerEdgeColor', 'none');
scatter(temp2(temp1(:, 1)), temp2(temp1(:, 2)), sz, [0 0 0], 'filled', 'MarkerEdgeColor', 'none');
ylabel('D_2 for nearest neighbors of i', 'FontSize', 25); xlabel('D_2 for node i');
set(gca, 'FontSize', fontsize);
text(letterposx, letterposy, 'e', 'Units', 'normalized', 'FontSize', 25, 'FontWeight', 'bold');
set(gca, 'FontSize', fontsize*2);
% legend('Present', 'Absent', 'FontSize', 13);
[r,p] = corr(temp2(temp1(:, 1)), temp2(temp1(:, 2)), 'rows', 'complete');
text(0.6, 0.15, "r = " + string(r) + newline + "p = " + string(p),...
...
% ylabel('$Q^i$', 'Interpreter', 'latex'); xlabel('$D_1^i$', 'Interpreter', 'latex');
% set(gca, 'FontSize', fontsize);
% text(0, 1.1, '(b)', 'Units', 'normalized', 'FontSize', 18, 'Interpreter', 'latex');
% % legend('Present', 'Absent', 'FontSize', 13);
% axis square;
% 
% 
...
% ylabel('$Q^i$', 'Interpreter', 'latex'); xlabel('$D_2^i$', 'Interpreter', 'latex');
% set(gca, 'FontSize', fontsize);
% text(0, 1.1, '(c)', 'Units', 'normalized', 'FontSize', 18, 'Interpreter', 'latex');
% % legend('Present', 'Absent', 'FontSize', 13);
% axis square;
% 
% 
...
% ylabel('$D_1^i$', 'Interpreter', 'latex'); xlabel('$D_2^i$', 'Interpreter', 'latex');
% set(gca, 'FontSize', fontsize);
